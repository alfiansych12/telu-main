    ...
    return (
        <Box sx={{ px: { xs: 0, sm: 2 } }}>
            ...
            <Grid container spacing={4}>
                ...
                {/* Settings Grid below Map */}
                <Grid item xs={12} md={6} lg={4}>
                    <MainCard
                        title="Attendance Time Rules"
                        sx={{ borderRadius: 4, border: 'none', boxShadow: `0 4px 20px ${alpha(theme.palette.common.black, 0.05)}`, height: '100%' }}
                    >
                        <Stack spacing={3}>
                    ...
                    <Stack spacing={3}>
                        ...
                        >
                            <Stack spacing={2}>
                                ...
                                />
                                <Box sx={{ mt: 1 }}>
                                    <Typography variant="caption" color="textSecondary">Radius Geofence</Typography>
                                    <Slider
